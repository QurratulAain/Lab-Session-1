// QNO. 01: Write a C program to display the first n odd natural numbers and their sum using for, while and 
// do-while loop.
// USING FOR LOOP;
// #include<stdio.h>
// int main(){
...
// }
// printf("\nThe sum of odd natural numbers upto %d is: %d",n,sum);return 0;}
//  QNO. 02: Write a C program to make the following pattern as a pyramid with an asterisk.
//  * 
//  * * 
// * * * 
// * * * *
...
// #include <stdio.h>
// int main()
// {int arr[100], n, i,j, a=1;
//     printf("Enter size of the array: ");
//     scanf("%d", &n);
//     for(i=0; i<n; i++)
//     {printf("Enter the %dth element in array of length %d: ",i,n);
//         scanf("%d", &arr[i]);
//     }
